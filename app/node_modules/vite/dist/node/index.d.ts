...
import { TransformOptions as EsbuildTransformOptions, version as esbuildVersion } from 'esbuild';
import * as events from 'node:events';
import { EventEmitter } from 'node:events';
import type * as fs from 'node:fs';
import type { Agent, ClientRequest, ClientRequestArgs, IncomingMessage } from 'node:http';
import * as http from 'node:http';
import type { Duplex, DuplexOptions } from 'node:stream';
import type { CustomPluginOptions, ExistingRawSourceMap, GetManualChunk, InputOption, InputOptions, LoadResult } from 'rollup';
import { CustomEventMap, InferCustomEventPayload, InvalidatePayload } from "vite/types/customEvent";
import { ConnectedPayload, CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload } from "vite/types/hmrPayload";
import { GeneralImportGlobOptions, ImportGlobEagerFunction, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from "vite/types/importGlob";
...
import type { ServerOptions as ServerOptions_2, Server as Server_2 } from 'node:https';
...
import type { ModuleFormat, ModuleInfo, ObjectHook, OutputBundle, OutputChunk, PartialResolvedId, PluginContext, PluginHooks, Plugin as Plugin_3, ResolveIdResult, RollupError, RollupOptions, RollupOutput, RollupWatcher, SourceDescription, SourceMap, SourceMapInput, TransformPluginContext, TransformResult as TransformResult_2, WatcherOptions } from 'rollup';
import { VERSION as rollupVersion } from 'rollup';
import { PrunePayload, Update, UpdatePayload } from "vite/types/hmrPayload";
